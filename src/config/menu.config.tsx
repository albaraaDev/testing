...
import { isAppRentACar } from './apptype';

export let MENU_SIDEBAR: TMenuConfig = [
  {
  ...
  isAppRentACar
    ? {
        title: 'SIDEBAR.MENU.RESERVATION',
        externalIcon: 'customer',
        children: [
          {
            title: 'SIDEBAR.MENU.RESERVATION.RESERVATION',
    ...
    : {},
  {
    title: 'SIDEBAR.MENU.WORKING_HOURS',
    externalIcon: 'reports',
    children: [
      {
        title: 'SIDEBAR.MENU.WORKING_HOURS.LIST',
        path: '/working-hours/list'
      },
      {
        title: 'SIDEBAR.MENU.WORKING_HOURS.CREATE',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        path: '/maintenance/maintenance-type/list',
        role: ['ADMIN', 'SUPER_ADMIN', 'MANAGER']
      },
      {
  ...
  {
    title: 'SIDEBAR.MENU.ROLE',
    externalIcon: 'user',
    path: '/roles/list',
    role: ['SUPER_ADMIN']
  },
  {
    title: 'SIDEBAR.MENU.MODIFICATION_REQUESTS',
    externalIcon: 'reports',
    path: '/modification-requests/list',
    role: ['SUPER_ADMIN', 'ADMIN']
  }
].filter((item) => item.title !== undefined && item.title !== null) as TMenuConfig;
